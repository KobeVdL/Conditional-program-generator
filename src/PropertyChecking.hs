...
--shrinking test for term of size 2
shrinkingStep1 :: Term  -> Maybe Term

shrinkingStep1 (MkTerm "ifThenElse" 3 [MkTerm "True" 0 [],MkTerm "succ" 1 [x],y]) = Nothing

shrinkingStep1 term = step term shrinkingStep1

-- shrinking test for term of size 3
shrinkingStep2 :: Term  -> Maybe Term

shrinkingStep2 (MkTerm "ifThenElse" 3 [MkTerm "True" 0 [],MkTerm "succ" 1 [x],MkTerm "succ" 1 [y]]) = Nothing

shrinkingStep2 term = step term shrinkingStep1
