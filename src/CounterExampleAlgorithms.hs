...
module CounterExampleAlgorithms where
...
fastBottomUpProperty :: Program ->  (Predicate -> Bool) -> Int -> Scheme -> Scheme -> Maybe Predicate
    
fastBottomUpProperty _ propCheck (-1) oldScheme differenceScheme = Nothing  
